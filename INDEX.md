...
本目录已经按职责整理，根目录保留 GitHub 入口 `README.md`、中文入口 `README.zh-CN.md` 和项目索引 `INDEX.md`；实际代码、配置、脚本、测试和细化文档都放在子目录中。
...
根目录只保留公开入口文档和 `INDEX.md`。新增代码、配置、脚本、测试、细化文档或历史归档时，应放入对应子目录，避免再次回到根目录平铺。
